...
import net.orandja.ktm.annotations.generation.AdapterGenerator
import net.orandja.ktm.annotations.generation.AutoGenerator
import net.orandja.ktm.annotations.generation.AutoToken
import net.orandja.ktm.annotations.generation.GeneratedFile
import net.orandja.ktm.annotations.visitor.TokenBuilderVisitor
...
class KtmSymbolProcessor(private val env: SymbolProcessorEnvironment) : SymbolProcessor {
    ...
    override fun finish() {
        ...
        configuration.packageName ?: run {
            logger.info("No package name provided, AutoKtmAdapter not generated.")
            return
        }
